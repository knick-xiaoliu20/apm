...
| Command | Purpose |
|---|---|
| `apm marketplace upstream add <repo> --alias <alias> --ref <sha>` | Register an upstream marketplace |
| `apm marketplace upstream add <repo> --alias <alias> --branch main --allow-head` | Track a mutable branch (warned) |
